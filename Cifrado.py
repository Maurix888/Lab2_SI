...
if __name__ == "__main__":
    ...
    # printing results
    print("\n")
    print("Mensaje de entrada:         {}".format(plainText))
    print("Mensaje de entrada a hexadecimal: {}".format(binToHex(plainBin)))
    print("Mensaje Cifrado:              {}".format(binToHex(C)))
print("Cifrado a hexadecimal:     {}".format(binToHex(result)))
print("Hexadecimal a mensaje:     {}\n".format(resultText))
